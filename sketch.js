...
function preload(){
  ...
  cycleBell = loadSound("images/bell.mp3");
...
mainCyclist.addAnimation("End Animation",mainRacerImg2);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("Click the up arrow to restart!",550,250)
    ...
    mainCyclist.changeAnimation("End Animation",mainRacerImg2);
